...
class User {
    ...
    Persona persona;
    List<ActivationCompanyUser> activationCompanyUsers;
    List<EstadoMensajeriaJornada> estadoMensajeriaJornadas;
    ...
    factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        persona: Persona.fromJson(json["persona"]),
        activationCompanyUsers: List<ActivationCompanyUser>.from(json["activation_company_users"].map((x) => ActivationCompanyUser.fromJson(x))),
        estadoMensajeriaJornadas: List<EstadoMensajeriaJornada>.from(json["estado_mensajeria_jornadas"].map((x) => EstadoMensajeriaJornada.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "persona": persona.toJson(),
        "activation_company_users": List<dynamic>.from(activationCompanyUsers.map((x) => x.toJson())),
        "estado_mensajeria_jornadas": List<dynamic>.from(estadoMensajeriaJornadas.map((x) => x.toJson())),
    };
}
...
class EstadoMensajeriaJornada {
    ...
    String numeroHoras;
    String idCompany;
    String idTipoJornada;
    DateTime createdAt;
    DateTime updatedAt;
    Pivot pivot;

    EstadoMensajeriaJornada({
        required this.id,
    ...
    factory EstadoMensajeriaJornada.fromJson(Map<String, dynamic> json) => EstadoMensajeriaJornada(
        id: json["id"],
        nombreJornada: json["nombreJornada"],
        descripcion: json["descripcion"],
...
class Persona {
    ...
    //DateTime createdAt;
    DateTime updatedAt;
    Contrato? contrato; // Propiedad nullable
    CiudadNac ubicacion;
    dynamic ciudad;
    CiudadNac ciudadNac;
    CiudadNac ciudadUbicacion;
    ...
    Persona({
       ...
       // required this.createdAt,
        required this.updatedAt,
        this.contrato, // Contrato puede ser null
        required this.ubicacion,
        required this.ciudad,
        required this.ciudadNac,
        required this.ciudadUbicacion,
    ...
    factory Persona.fromJson(Map<String, dynamic> json) => Persona(
        ...
        //createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        contrato: json["contrato"] != null ? Contrato.fromJson(json["contrato"]) : null, // Manejar null
        ubicacion: CiudadNac.fromJson(json["ubicacion"]),
        ciudad: json["ciudad"],
        ciudadNac: CiudadNac.fromJson(json["ciudad_nac"]),
        ciudadUbicacion: CiudadNac.fromJson(json["ciudad_ubicacion"]),
    ...
    Map<String, dynamic> toJson() => {
       ...
       // "created_at": createdAt.toIso8601String(),
        "updated_at": updatedAt.toIso8601String(),
        "contrato": contrato?.toJson(), // Manejar null
        "ubicacion": ubicacion.toJson(),
        "ciudad": ciudad,
        "ciudad_nac": ciudadNac.toJson(),
        "ciudad_ubicacion": ciudadUbicacion.toJson(),
