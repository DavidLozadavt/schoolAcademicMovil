...
class NotificationScreen extends StatelessWidget {
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    if (_notificationsController
                                      ...
                                      if(_notificationsController.activities[index]['estado']['estado'] == 'ACTIVO'){
  ...
  void showNotificationDetails(BuildContext context, Map<String, dynamic> notificationData) {
    Get.bottomSheet(
